...
const UUID = process.env.UUID || 'd45f1c46-4523-997d-d71f-ae9cd50c56f3'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';       // v1形式：nz.abc.com:8008   v0形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'zlibdotskhuugfeace.aminomiatusccf.us.to';       // 
const AUTO_ACCESS = process.env.AUTO_ACCESS || true;       // 
const WSPATH = process.env.WSPATH || UUID.slice(0, 16);     // 
const SUB_PATH = process.env.SUB_PATH || 'subsadminn';     // 
const NAME = process.env.NAME || 'hugfc';                       // 
